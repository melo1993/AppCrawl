...
csvfile = file('/Users/nuo/Downloads/babamai1.csv','wb')
...
count = 0
loginData = "d=%7B%0A%20%20%22currPage%22%20%3A%20%223%22%2C%0A%20%20%22tagTypeId%22%20%3A%20%223ogct1vdduta0itdvt%22%0A%7D&t="+str(random.random())+""
print loginData
cookieJar = CookieJar()
